        ...
        .then((result) => {
          ...
          if (result.data.code == 400) {
            let iconData = [
              {
                type: "latte",
                icon: require("../../assets/images/coffee-icon_05.gif"),
                activeIcon: require("../../assets/images/coffee-icon_19.gif"),
              },
              {
                type: "coffee",
                icon: require("../../assets/images/coffee-icon_03.gif"),
                activeIcon: require("../../assets/images/coffee-icon_18.gif"),
              },
              {
                type: "rena_ice",
                icon: require("../../assets/images/coffee-icon_07.gif"),
                activeIcon: require("../../assets/images/coffee-icon_20.gif"),
              },
            ];
            ...
            result.data.result.unshift({
              type: "isHot",
              typeDesc: "推荐",
              icon: require("../../assets/images/coffee-icon_09.gif"),
              activeIcon: require("../../assets/images/coffee-icon_21.gif"),
              isActive: true,
            });
